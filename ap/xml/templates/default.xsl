...
<nav>
	...
	<aside>
		...
		<p class="site"><a href="http://{/page/site/@domain}/" target="_blank">watch page on the site</a></p>
	</aside>
</nav>
<header>
	<h1>
...
<section>
	...
	<nav>
		<h1 class="bookmark"><span>Content<em></em></span></h1>
		<xsl:apply-templates select="/page/structure" mode="struct"/>
	</nav>
</section>
<footer><p>© Forumedia 2013</p></footer>
</body>
</html>
</xsl:template>
...
<xsl:template match="/page/site/users/user[@selected]">
	<p class="profile">
		...
		<a href="?id=apUsers&amp;row={@login}&amp;action=edit">Profile</a> - <a href="?action=logout">Exit</a>
	</p>
</xsl:template>
