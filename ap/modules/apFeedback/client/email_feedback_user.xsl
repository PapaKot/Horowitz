...
<xsl:template match="/email">
	<div style="height:100%; width:600px; margin:20px; text-align: left;">
		...
		<h1 style="font-family:Tahoma, Geneva, sans-serif;font-size:18px;font-weight:normal;color:#4496d1;text-transform:uppercase;padding:0;margin:0 0 15px;">Post feedback form</h1>
		<p style="padding:0 0 14px 0;">Your message has been accepted!</p>
		
		<xsl:if test="./field[@name='message']">
			<h2 style="font-family:Tahoma, Geneva, sans-serif;font-size:16px;font-weight:bold;color:#454545;padding:0;margin:0 0 5px;">Message text</h2>
		...
		<hr/>
		<p style="padding:0 0 14px 0;">Message from the site <a style="color:#4496d1;" href="http://{@domain}/"><xsl:value-of select="@name" /></a></p>
	</div>
</xsl:template>
