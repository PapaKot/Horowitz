...
<html>
<head>
	<title>Feedback <xsl:value-of select="/email/@name" /></title>
...
<xsl:template match="/email">
	 <div style="height:100%; width:600px; margin:20px; text-align: left;">
		...
		<hr/>
		<p style="padding:0 0 14px 0;">Email was sent from <a style="color:#4496d1;" href="http://{@domain}/"><xsl:value-of select="@name" /></a></p>
	</div>
</xsl:template>
