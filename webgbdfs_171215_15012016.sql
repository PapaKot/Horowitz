...
--
-- Хост: localhost:3306
-- Время создания: Янв 14 2016 г., 16:46
...
(25, 'news', 'm1', '2016-01-14 00:00:00', 'Проверка ленты', 'Это сообщение для проверки работы ленты новостей - анонс.', '<p>Это сообщение для проверки работы ленты новостей - текст.</p>', 1, 7),
